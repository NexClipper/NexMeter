...
-Dorg.killbill.dao.user=$KILLBILL_DAO_USER
-Dorg.killbill.dao.password=$KILLBILL_DAO_PASSWORD
-Dorg.killbill.billing.osgi.dao.url=$KILLBILL_DAO_URL
-Dorg.killbill.billing.osgi.dao.user=$KILLBILL_DAO_USER
-Dorg.killbill.billing.osgi.dao.password=$KILLBILL_DAO_PASSWORD
-Dkaui.db.adapter=mariadb
-Dkaui.url=http://127.0.0.1:8080
-Dkaui.db.url=jdbc:mysql://$DB_HOST:$DB_PORT/kaui
-Dkaui.db.username=$DB_USER
